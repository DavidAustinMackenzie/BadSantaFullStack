...
@Component({
  selector: 'app-admin-edit-badsanta',
  templateUrl: './admin-edit-badsanta.component.html',
  styleUrl: './admin-edit-badsanta.component.css'
})

export class AdminEditBadsantaComponent 
{
